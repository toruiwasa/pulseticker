...
export type IconName =
  'chart-bar' | 'list' | 'bell' | 'compass' | 'settings' | 'sun' | 'moon' | 'monitor';
...
const ICONS: Record<IconName, IconPath[]> = {
  ...
  compass: [{ d: 'M8 16l2-6 6-2-2 6z' }, { d: 'M12 21a9 9 0 1 0 0-18a9 9 0 0 0 0 18z' }],
  settings: [
    {
  ...
  moon: [{ d: 'M12 3h.393a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 12 2.992z' }],
  monitor: [
